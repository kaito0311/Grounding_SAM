...
CLASSES = ["mask", "eyeglasses", "watch", "sunglasses"]
BOX_THRESHOLD = 0.25
TEXT_THRESHOLD = 0.25
NMS_THRESHOLD = 0.8
...
MOBILE_SAM_CHECKPOINT_PATH = "/home/data2/tanminh/Detic/Grounded-Segment-Anything/EfficientSAM/mobile_sam.pt"
...
for path_image in tqdm(os.listdir(root_dir)):
    process_segment(os.path.join(root_dir, path_image))
